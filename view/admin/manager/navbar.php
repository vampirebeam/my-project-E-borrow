...
<div class="border-end bg-light" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a class="list-group-item list-group-item-action list-group-item-light p-3" href="index"><i class="fa-solid fa-screwdriver-wrench fa-1x"></i>&nbsp;ส่วนของผู้ดูแลระบบ</a>
