...
<div class="border-end bg-white" id="sidebar-wrapper">
                <div class="sidebar-heading border-bottom bg-light">ระบบยืม-คืนอุปกรณ์</div>
                <div class="list-group list-group-flush">
                    ...
                    <a href="logout" class="list-group-item list-group-item-action list-group-item-danger p-3 btn btn-danger" onclick="return confirm('ต้องการออกจากระบบใช่ไหม?');">ออกจากระบบ</a>
                </div>
            </div>
